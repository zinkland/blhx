...
if [ ! -f "com.bilibili.AzurLane.apk" ]; then
    ...
    wget "https://gc.s.migames.com/gdownload/api/c/download?c=app&v=download&package=com.bilibili.blhx.mi&channel=meng_1439_352_android" -O com.bilibili.AzurLane.apk -q
